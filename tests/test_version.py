...
CURRENT_PLUGIN_VERSION = "0.0.26.post3"
CURRENT_RELEASE_VERSION = "0.0.26.post3"
CURRENT_PACKAGE_VERSION = "0.0.26.post3"
CURRENT_PROXBOX_API_PAIRING_LABEL = "v0.0.21.post7"
CURRENT_PAIRING_LINE = (
    "Current backend-runtime pairing: netbox-proxbox 0.0.26.post3 <-> proxbox-api "
...
CURRENT_RELEASE_NOTES_PATH = RELEASE_NOTES_026_POST3_PATH
