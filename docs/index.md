...
- Plugin version `0.0.26.post4` in source
...
The `0.0.26.post4` release aligns the migration helper with the currently deployed production digest while retaining the production console handoff and the official NetBox 4.7.0 GA compatibility
contract while
